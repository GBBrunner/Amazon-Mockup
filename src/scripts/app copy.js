...
function createProduct(name, price, imageUrl) {
    ...
    for (let i =0; i < boxCount; i++) {
        ...
        <img src="${imageUrl}" alt="Product Image" class="w-10/12 h-50 object-center mb-4 overflow-hidden object-cover rounded-xl">
        <div class="flex-grow pl-3">
            <p id="product-name${i}" class="mb-4">${name}</p>
            <p data-price-value="${price}" class="mb-4 text-lg font-bold" id="product-price${i}">$${price}</p>
